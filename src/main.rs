...
fn main() {
    ...
    fill_polygon_scaled(&mut framebuffer, &[
        ...
        rvec2(632.0, 230.0), rvec2(580.0, 230.0), rvec2(605.0, 215.0), rvec2(552.0, 214.0),
        rvec2(517.0, 144.0), rvec2(466.0, 180.0)
    ], 350000);

    framebuffer.set_current_color(Color::WHITE);
    draw_polygon_outline(&mut framebuffer, &[
        rvec2(413.0, 177.0), rvec2(448.0, 159.0), rvec2(502.0, 88.0), rvec2(545.0, 56.0),
        rvec2(535.0, 36.0), rvec2(676.0, 37.0), rvec2(660.0, 52.0), rvec2(750.0, 145.0),
        rvec2(761.0, 179.0), rvec2(672.0, 192.0), rvec2(659.0, 214.0), rvec2(625.0, 214.0),
        rvec2(632.0, 230.0), rvec2(580.0, 230.0), rvec2(587.0, 215.0), rvec2(552.0, 214.0),
        rvec2(527.0, 168.0), rvec2(466.0, 180.0)
    ]);
